    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-6 px-4">
        ...
        <div className="flex items-center gap-4">
          <Link href="/" className="flex items-center gap-1.5 text-[13px] font-medium text-brand-navy hover:text-brand-blue">
            <Headset className="size-4.5" />
            <span className="hidden lg:inline">{t('header.help')}</span>
          </Link>

          <Link href="/" aria-label={t('header.ariaUser')} className="text-brand-navy hover:text-brand-blue">
            <User className="size-5.5" />
          </Link>

          <Link href="/" aria-label={t('header.ariaCart')} className="relative text-brand-navy hover:text-brand-blue">
